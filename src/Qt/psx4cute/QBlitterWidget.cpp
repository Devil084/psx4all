...
extern quint8* gp2x_sdlwrapper_screen_pixels;
...
void QBlitterWidget::render()
    ...
    bitmapBlit( (TUint8*) gp2x_sdlwrapper_screen_pixels, bitmapdata);
...
void QBlitterWidget::startDSA()
	...
	if(!iDSA)
	    ...
	    //User::LeaveIfError(iDSBitmap->Create(TRect(160,0,640,360), CDirectScreenBitmap::EDoubleBuffer));
	    User::LeaveIfError(iDSBitmap->Create(TRect(0,0,640,360), CDirectScreenBitmap::EDoubleBuffer));
	    }
	__DEBUG_OUT
	}
