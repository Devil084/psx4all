...
ViewController::ViewController()
{
    ...
    connect(settingsView, SIGNAL(LoadROM( QString,TPsxSettings)), this, SLOT(loadROM( QString,TPsxSettings)));
    ...
    connect(settingsView, SIGNAL(updateSettings(TPsxSettings)), emuView, SLOT(updateSettings(TPsxSettings)));
...
void ViewController::loadROM( QString rom, TPsxSettings antSettings )
    {
    __DEBUG_IN
